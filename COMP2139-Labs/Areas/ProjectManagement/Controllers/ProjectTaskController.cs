...
public class ProjectTaskController: Controller
{
    ...
    [HttpPost("Create/{projectId:int}")]//we are passing the id in the hidden field in the form
    ...
    public async Task<IActionResult> Search(int? projectId, string searchString)
    {
        ...
        ViewBag.ProjectId = projectId;
        ViewData["SearchString"] = searchString;//temporary to pass info to the resultant view. but it is going to be after the request
